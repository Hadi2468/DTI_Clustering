...
ggplot(master_data, aes(x = Kmeans_4, y = GIA_base, color = Kmeans_4, fill = Kmeans_4)) + 
  ggtitle("K-Means (baseline)") + xlab("\n Kruskal–Wallis test,   p-value = 0.8877") + ylab("GIA") + 
...
ggplot(master_data, aes(x = Kmeans_Sparse_4, y = Proc_Spd_base, color = Kmeans_Sparse_4, fill = Kmeans_Sparse_4)) + 
  ggtitle("K-Means Sparse (baseline)") + xlab("\n Kruskal–Wallis test,   p-value = 0.6865") + ylab("Process Speed") + 
  geom_boxplot(size = 0.8, outlier.size = 3) + scale_fill_drsimonj(palette = "cool") + scale_color_drsimonj(palette = "hot") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5)) + coord_cartesian(ylim = c(30, 130))
# Box-plot 5
ggplot(master_data, aes(x = Kmeans_4, y = Working_Mem_base, color = Kmeans_4, fill = Kmeans_4)) + 
  ggtitle("K-Means (baseline)") + xlab("\n Kruskal–Wallis test,   p-value = 0.7489") + ylab("Working Memory") + 
  geom_boxplot(size = 0.8, outlier.size = 3) + scale_fill_drsimonj(palette = "cool") + scale_color_drsimonj(palette = "hot") +
...
ggplot(master_data, aes(x = Kmeans_4, y = Proc_Spd_diff, color = Kmeans_4, fill = Kmeans_4)) + 
  ggtitle("K-Means (36 months - baseline)") + xlab("\n Kruskal–Wallis test,   p-value = 0.0912") + ylab("Process Speed") + 
  geom_boxplot(size = 0.8, outlier.size = 3) + scale_fill_drsimonj(palette = "cool") + scale_color_drsimonj(palette = "hot") +
...
ggplot(master_data, aes(x = Kmeans_4, y = Working_Mem_diff, color = Kmeans_4, fill = Kmeans_4)) + 
  ggtitle("K-Means (36 months - baseline)") + xlab("\n Kruskal–Wallis test,   p-value = 0.9291") + ylab("Working Memory") + 
  geom_boxplot(size = 0.8, outlier.size = 3) + scale_fill_drsimonj(palette = "cool") + scale_color_drsimonj(palette = "hot") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5)) + coord_cartesian(ylim = c(-50, 30))
# Box-plot 14
...
res <- wilcox.test(GIA_base ~ Kmeans_2, data = master_data, alternative = "two.sided", exact = FALSE)
res
res$p.value

wilcox.test(GIA_base         ~ Kmeans_2, data = master_data, exact = FALSE)
wilcox.test(Proc_Spd_base    ~ Kmeans_2, data = master_data, exact = FALSE)
wilcox.test(Working_Mem_base ~ Kmeans_2, data = master_data, exact = FALSE)
wilcox.test(Broad_Attn_base  ~ Kmeans_2, data = master_data, exact = FALSE)
wilcox.test(GIA_base         ~ Kmeans_Sparse_2, data = master_data, exact = FALSE)
wilcox.test(Proc_Spd_base    ~ Kmeans_Sparse_2, data = master_data, exact = FALSE)
wilcox.test(Working_Mem_base ~ Kmeans_Sparse_2, data = master_data, exact = FALSE)
wilcox.test(Broad_Attn_base  ~ Kmeans_Sparse_2, data = master_data, exact = FALSE)

wilcox.test(GIA_diff         ~ Kmeans_2, data = master_data, exact = FALSE)
wilcox.test(Proc_Spd_diff    ~ Kmeans_2, data = master_data, exact = FALSE)
wilcox.test(Working_Mem_diff ~ Kmeans_2, data = master_data, exact = FALSE)
wilcox.test(Broad_Attn_diff  ~ Kmeans_2, data = master_data, exact = FALSE)
wilcox.test(GIA_diff         ~ Kmeans_Sparse_2, data = master_data, exact = FALSE)
wilcox.test(Proc_Spd_diff    ~ Kmeans_Sparse_2, data = master_data, exact = FALSE)
wilcox.test(Working_Mem_diff ~ Kmeans_Sparse_2, data = master_data, exact = FALSE)
wilcox.test(Broad_Attn_diff  ~ Kmeans_Sparse_2, data = master_data, exact = FALSE)

##---------------------- Box plots for Wilcoxon rank sum tests -------------------------------------------------------------------------
# Box-plot 1
ggplot(master_data, aes(x = Kmeans_2, y = GIA_base, color = Kmeans_2, fill = Kmeans_2)) + 
  ggtitle("K-Means (baseline)") + xlab("\n Wilcoxon-rank-sum test,   p-value = 0.0872") + ylab("GIA") + 
  geom_boxplot(size = 0.8, outlier.size = 3) + scale_fill_drsimonj(palette = "cool") + scale_color_drsimonj(palette = "hot") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5)) + coord_cartesian(ylim = c(50, 130))
# Box-plot 2
ggplot(master_data, aes(x = Kmeans_Sparse_2, y = GIA_base, color = Kmeans_Sparse_2, fill = Kmeans_Sparse_2)) + 
  ggtitle("K-Means Sparse (baseline)") + xlab("\n Wilcoxon-rank-sum test,   p-value = 0.3782") + ylab("GIA") + 
  geom_boxplot(size = 0.8, outlier.size = 3) + scale_fill_drsimonj(palette = "cool") + scale_color_drsimonj(palette = "hot") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5)) + coord_cartesian(ylim = c(50, 130))
# Box-plot 3
ggplot(master_data, aes(x = Kmeans_2, y = Proc_Spd_base, color = Kmeans_2, fill = Kmeans_2)) + 
  ggtitle("K-Means (baseline)") + xlab("\n Wilcoxon-rank-sum test,   p-value = 0.2726") + ylab("Process Speed") + 
  geom_boxplot(size = 0.8, outlier.size = 3) + scale_fill_drsimonj(palette = "cool") + scale_color_drsimonj(palette = "hot") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5)) + coord_cartesian(ylim = c(40, 130))
# Box-plot 4
ggplot(master_data, aes(x = Kmeans_Sparse_2, y = Proc_Spd_base, color = Kmeans_Sparse_2, fill = Kmeans_Sparse_2)) + 
  ggtitle("K-Means Sparse (baseline)") + xlab("\n Wilcoxon-rank-sum test,   p-value = 0.3719") + ylab("Process Speed") + 
  geom_boxplot(size = 0.8, outlier.size = 3) + scale_fill_drsimonj(palette = "cool") + scale_color_drsimonj(palette = "hot") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5)) + coord_cartesian(ylim = c(40, 130))
# Box-plot 5
ggplot(master_data, aes(x = Kmeans_2, y = Working_Mem_base, color = Kmeans_2, fill = Kmeans_2)) + 
  ggtitle("K-Means (baseline)") + xlab("\n Wilcoxon-rank-sum test,   p-value = 0.1432") + ylab("Working Memory") + 
  geom_boxplot(size = 0.8, outlier.size = 3) + scale_fill_drsimonj(palette = "cool") + scale_color_drsimonj(palette = "hot") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5)) + coord_cartesian(ylim = c(50, 140))
# Box-plot 6
ggplot(master_data, aes(x = Kmeans_Sparse_2, y = Working_Mem_base, color = Kmeans_Sparse_2, fill = Kmeans_Sparse_2)) + 
  ggtitle("K-Means Sparse (baseline)") + xlab("\n Wilcoxon-rank-sum test,   p-value = 0.6953") + ylab("Working Memory") + 
  geom_boxplot(size = 0.8, outlier.size = 3) + scale_fill_drsimonj(palette = "cool") + scale_color_drsimonj(palette = "hot") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5)) + coord_cartesian(ylim = c(50, 140))
# Box-plot 7
ggplot(master_data, aes(x = Kmeans_2, y = Broad_Attn_base, color = Kmeans_2, fill = Kmeans_2)) + 
  ggtitle("K-Means (baseline)") + xlab("\n Wilcoxon-rank-sum test,   p-value = 0.4197") + ylab("Broad Attention") + 
  geom_boxplot(size = 0.8, outlier.size = 3) + scale_fill_drsimonj(palette = "cool") + scale_color_drsimonj(palette = "hot") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5)) + coord_cartesian(ylim = c(50, 130))
# Box-plot 8
ggplot(master_data, aes(x = Kmeans_Sparse_2, y = Broad_Attn_base, color = Kmeans_Sparse_2, fill = Kmeans_Sparse_2)) + 
  ggtitle("K-Means Sparse (baseline)") + xlab("\n Wilcoxon-rank-sum test,   p-value = 0.7417") + ylab("Broad Attention") + 
  geom_boxplot(size = 0.8, outlier.size = 3) + scale_fill_drsimonj(palette = "cool") + scale_color_drsimonj(palette = "hot") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5)) + coord_cartesian(ylim = c(50, 130))
# Box-plot 9
ggplot(master_data, aes(x = Kmeans_2, y = GIA_diff, color = Kmeans_2, fill = Kmeans_2)) + 
  ggtitle("K-Means (36 months - baseline)") + xlab("\n Wilcoxon-rank-sum test,   p-value = 0.8454") + ylab("GIA") + 
  geom_boxplot(size = 0.8, outlier.size = 3) + scale_fill_drsimonj(palette = "cool") + scale_color_drsimonj(palette = "hot") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5)) + coord_cartesian(ylim = c(-50, 30))
# Box-plot 10
ggplot(master_data, aes(x = Kmeans_Sparse_2, y = GIA_diff, color = Kmeans_Sparse_2, fill = Kmeans_Sparse_2)) + 
  ggtitle("K-Means Sparse (36 months - baseline)") + xlab("\n Wilcoxon-rank-sum test,   p-value = 0.3531") + ylab("GIA") + 
  geom_boxplot(size = 0.8, outlier.size = 3) + scale_fill_drsimonj(palette = "cool") + scale_color_drsimonj(palette = "hot") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5)) + coord_cartesian(ylim = c(-50, 30))
# Box-plot 11
ggplot(master_data, aes(x = Kmeans_2, y = Proc_Spd_diff, color = Kmeans_2, fill = Kmeans_2)) + 
  ggtitle("K-Means (36 months - baseline)") + xlab("\n Wilcoxon-rank-sum test,   p-value = 0.4406") + ylab("Process Speed") + 
  geom_boxplot(size = 0.8, outlier.size = 3) + scale_fill_drsimonj(palette = "cool") + scale_color_drsimonj(palette = "hot") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5)) + coord_cartesian(ylim = c(-50, 60))
# Box-plot 12
ggplot(master_data, aes(x = Kmeans_Sparse_2, y = Proc_Spd_diff, color = Kmeans_Sparse_2, fill = Kmeans_Sparse_2)) + 
  ggtitle("K-Means Sparse (36 months - baseline)") + xlab("\n Wilcoxon-rank-sum test,   p-value = 0.7407") + ylab("Process Speed") + 
  geom_boxplot(size = 0.8, outlier.size = 3) + scale_fill_drsimonj(palette = "cool") + scale_color_drsimonj(palette = "hot") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5)) + coord_cartesian(ylim = c(-50, 60))
# Box-plot 13
ggplot(master_data, aes(x = Kmeans_2, y = Working_Mem_diff, color = Kmeans_2, fill = Kmeans_2)) + 
  ggtitle("K-Means (36 months - baseline)") + xlab("\n Wilcoxon-rank-sum test,   p-value = 0.7555") + ylab("Working Memory") + 
  geom_boxplot(size = 0.8, outlier.size = 3) + scale_fill_drsimonj(palette = "cool") + scale_color_drsimonj(palette = "hot") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5)) + coord_cartesian(ylim = c(-50, 30))
# Box-plot 14
ggplot(master_data, aes(x = Kmeans_Sparse_2, y = Working_Mem_diff, color = Kmeans_Sparse_2, fill = Kmeans_Sparse_2)) + 
  ggtitle("K-Means Sparse (36 months - baseline)") + xlab("\n Wilcoxon-rank-sum test,   p-value = 0.2286") + ylab("Working Memory") + 
  geom_boxplot(size = 0.8, outlier.size = 3) + scale_fill_drsimonj(palette = "cool") + scale_color_drsimonj(palette = "hot") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5)) + coord_cartesian(ylim = c(-50, 30))
# Box-plot 15
ggplot(master_data, aes(x = Kmeans_2, y = Broad_Attn_diff, color = Kmeans_2, fill = Kmeans_2)) + 
  ggtitle("K-Means (36 months - baseline)") + xlab("\n Wilcoxon-rank-sum test,   p-value = 0.2816") + ylab("Broad Attention") + 
  geom_boxplot(size = 0.8, outlier.size = 3) + scale_fill_drsimonj(palette = "cool") + scale_color_drsimonj(palette = "hot") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5)) + coord_cartesian(ylim = c(-50, 30))
# Box-plot 16
ggplot(master_data, aes(x = Kmeans_Sparse_2, y = Broad_Attn_diff, color = Kmeans_Sparse_2, fill = Kmeans_Sparse_2)) + 
  ggtitle("K-Means Sparse (36 months - baseline)") + xlab("\n Wilcoxon-rank-sum test,   p-value = 0.4953") + ylab("Broad Attention") + 
  geom_boxplot(size = 0.8, outlier.size = 3) + scale_fill_drsimonj(palette = "cool") + scale_color_drsimonj(palette = "hot") +
  theme(legend.position = "none", plot.title = element_text(hjust = 0.5)) + coord_cartesian(ylim = c(-50, 30))
